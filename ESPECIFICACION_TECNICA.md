...
- `mapFirebaseError()` en `AuthContext.jsx` traduce códigos de error de Firebase a mensajes en español — mantenerlo actualizado si se agregan más flujos (reset de contraseña, verificación de correo).
- **Pendiente:** no hay verificación de correo electrónico ni flujo de "olvidé mi contraseña" implementados todavía. Ambos son casi obligatorios antes de un lanzamiento real.
